  ...
  return (
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative mb-12 overflow-hidden rounded-lg">
        {/* background artwork with stronger darkening on left for readability */}
        <div className="absolute inset-0 -z-10">
          <Image src="/hero-bg.png" alt="Hero background" fill className="object-cover brightness-75" priority unoptimized />
          {/* darken left + subtle right fade so text is always readable */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 sm:py-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            <div className="lg:col-span-7">
              {/* translucent panel behind text for max contrast */}
              <div className="inline-block rounded-lg bg-black/60 backdrop-blur-sm px-5 py-6 sm:px-8 sm:py-8">
            ...
            {/* feature shoe artwork: lowered and reduced opacity so it doesn't compete with text */}
            <div className="lg:col-span-5 hidden lg:block relative">
              <div className="pointer-events-none absolute -right-6 -bottom-6 w-[300px] max-w-[34vw] opacity-95 translate-y-6">
                <Image
                  src="/feature.png"
                  alt="Featured shoe"
                  width={900}
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {trending.map((t) => (
            <a
              ...
              aria-label={t.alt}
            >
              <div className="relative h-36 sm:h-44"> {/* reduced card image height */}
                <Image
                  src={t.src}
                  alt={t.alt}
                  fill
